...
class InventoryController extends BaseController_1.BaseController {
  constructor(menu, inventory) {
    ...
    this.editStockAction = () =>
      __awaiter(this, void 0, void 0, function* () {
        const item = yield this.getItemInput();
        const quantity = yield this.getNumberInput(
          "Enter quantity:",
          "Invalid quantity",
        );
        ...
        this.menu.outputMessage(
          `${item.getName()} quantity set to ${quantity}`,
        );
      });
    this.addInventoryAction = () =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        const price = yield this.getNumberInput(
          "Enter item price:",
          "Invalid price",
        );
        const supplierPrice = yield this.getNumberInput(
        ...
        const lowStockThreshold = yield this.getNumberInput(
